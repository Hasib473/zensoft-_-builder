...
const StestingDev = () => {
  const tags = ["Selenium", "TestNG", "Apache JMeter", "Appium"];
  return (
    <div>
      <section className="bg-[#e9edf6] py-20">
        <div className="max-w-3xl mx-auto text-center px-6">
          ...
          >
            Our testing ensures your software is reliable, secure, and performs
            flawlessly with tailored automation.
          </motion.p>
          ...
          >
            ...
            scalable — built to perform across all devices and platforms. While
            others chase trends, we focus on creating elegant interfaces paired
            with secure, high-performing backends. Our developers specialize in
            delivering seamless mobile solutions for startups, SMEs, and
            enterprises, tailored to industries like e-commerce, healthcare,
            banking.
          </motion.p>
